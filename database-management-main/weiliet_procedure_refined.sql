...
PROMPT =========================================================
PROMPT = A) Insert a valid schedule (far future so no overlap)
PROMPT =========================================================
DECLARE
...
PROMPT =========================================================
PROMPT = B) Overlap attempt for same bus (should raise ORA-20003)
PROMPT =========================================================
DECLARE
  v_new_id  Schedule.schedule_id%TYPE;
  v_bus_id  Bus.bus_id%TYPE;
...
PROMPT =========================================================
PROMPT = C) Boundary touching (should succeed)
PROMPT =========================================================
DECLARE
  v_new_id  Schedule.schedule_id%TYPE;
  v_bus_id  Bus.bus_id%TYPE;
