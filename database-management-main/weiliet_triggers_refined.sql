...
PROMPT =========================================================
PROMPT = Overlap test (should FAIL with ORA-20021)
PROMPT =========================================================
...
PROMPT =========================================================
PROMPT = Boundary-touching test (should SUCCEED)
PROMPT =========================================================
SELECT bus_id, departure_time, arrival_time, status
FROM   (SELECT bus_id, departure_time, arrival_time, status
        FROM   Schedule
...
-- Suppose schedule_id = 101
UPDATE Schedule
SET status = 'Cancelled'
WHERE schedule_id = 4376;
COMMIT;
